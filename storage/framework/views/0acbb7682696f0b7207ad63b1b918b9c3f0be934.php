...
<script>
    const routes = {
        settingObject: "<?php echo e(route('get.settings.object')); ?>",
        funcObject: "<?php echo e(route('getObjects')); ?>",
    }
</script>
...
<?php /**PATH C:\xampp\htdocs\tracking\resources\views/layouts/scripts.blade.php ENDPATH**/ ?>