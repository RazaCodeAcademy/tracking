...
@section('scripts')
    <script>
        ...
        const getObjectHistoryData = async (obj) => {
            try {
                ...
                const response = await $.ajax({
                    url: `{{ route('getObjectHistory') }}?cmd=${obj.cmd}&imei=${obj.imei}&dtf=${obj.dtf}&dtt=${obj.dtt}&min_stop_duration=${obj.msd}`,
                    type: "GET",
                });
        ...
        const getEventsData = async () => {
            try {
                const response = await $.ajax({
                    url: `{{ route('getEventsList') }}` + (global.event_last_id != '' ?
        ...
        const resolveEvent = async () => {
            try {
                const response = await $.ajax({
                    url: `{{ route('resolveEvent') }}?last_id="${global.resolveEventId}"`,
                    type: "GET",
                });
