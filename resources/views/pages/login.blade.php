...
<body>
    ...
    <div class="d-lg-flex half">
        <div class="bg order-2 order-md-1" {{-- style="background-image: url({{ asset('public/login/images/bg_1.jpg') }});" --}}>
            <div id="carouselExampleIndicators" style="height: 100%" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" style="height: 100%">
                    <div class="carousel-item active" style="height: 100%">
                        <img class="d-block w-100" style="height: 100%" src="{{ asset('/public/img/login-back.gif') }}"
                            alt="First slide">
