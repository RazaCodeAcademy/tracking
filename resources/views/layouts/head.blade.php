<head>
    ...
    <!-- Font Awesome 4 CSS -->
    <link rel="stylesheet" href="{{ asset('/public/css/font-awesome-4/css/font-awesome.min.css') }}" />
    <!-- Bootstrap 4.6x CSS -->
    <!-- <link rel="stylesheet" href="css/bootstrap-4.6x/bootstrap.min.css') }}" /> -->
    <!-- Bootstrap 5.0 beta 2 CSS -->
    <link rel="stylesheet" href="{{ asset('/public/css/bootstrap-5.0/bootstrap.min.css') }}" />
    <!-- Bootstrap 5.0 beta 2 RTL CSS -->
    <!-- <link rel="stylesheet" href="{{ asset('/public/css/bootstrap-5.0/bootstrap.rtl.min.css') }}" /> -->
    <!-- Custom CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('/public/css/MarkerCluster.Default.css') }}" />
    <link rel="stylesheet" href="{{ asset('/public/css/leaflet-routing-machine.css') }}" />
